$(document).ready(function() {
    ...
    */
    ...
    //spinner.animate({ transform: 'r60,0,0' }, 5000)
    //spinner.animate({ transform: "R60t0" }, 5000)
    ...
    s.circle(bb.cx, bb.cy, 5).attr({ opacity: 0.5 });
    mat.rotate(60, bb.cx, bb.cy);
    mat.translate(0, 0);
    //s.select("#spinner").animate({ transform: mat }, 5000);
